...
if (fs.existsSync('./lib/auth_info_baileys/image/' + Config.LANG + '.json')) {	
	//log(pint('Loading ' + Config.LANG + ' language...', '.'));	
	var json = JSON.parse(fs.readFileSync('./lib/auth_info_baileys/image/' + Config.LANG + '.json'));	
} else {	
	var json = JSON.parse(fs.readFileSync('./lib/auth_info_baileys/image/DiLSHAN-MD.json'));	
}	
