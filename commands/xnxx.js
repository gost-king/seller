  ...
  try {
    if (!text.startsWith("https://www.xnxx.com/") && !text.startsWith("https://xnxx.com/")) {
      ...
      await Void.sendMessage(citel.sender, {
        image: {
          url: 'https://i.ibb.co/d6Y70vv/Picsart-23-08-30-13-46-26-598.png',
        },
        caption: texttt,
      });
    } else {
...
const ttile = xndl.result.title;
      ...
      │🥷⃟🔞 *Title:* ${xndl.result.title}
      
      │🥷⃟🔞 *Duration:* ${xndl.result.duration}
      
      │🥷⃟🔞 *Viewers:* ${xndl.result.views}`
