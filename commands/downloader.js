             ...
             //   citel.reply('*Downloadig:* '+titleYt)
                ...
                if (fileSizeInMegabytes <= dlsize) {
                    let buttonMessage = {
                        ...
                        mimetype: 'video/mp4',
                        caption:` 
 𝚅𝙸𝙳𝙴𝙾 𝚄𝙿𝙻𝙾𝙳𝙸𝙽𝙶 𝙱𝚈 𝙳𝙰𝚁𝙺 𝙽𝙴𝚁𝙾 𝚅9 🧸
 `,   
		    }
                 Void.sendMessage(citel.chat, buttonMessage, { quoted: citel })
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let search = await yts(text);
            let textt = "*ᴅᴀʀᴋ ɴᴇʀᴏ ʏᴏᴜ ᴛᴜʙ ꜱᴇᴀʀᴄʜ*\n  💎 Result From " + text + "\n   ─────────────────── \n";
            let no = 1;
...
┗━━━━━━━━━━━━━┛
*reply 1 to download mp3*\n*reply 2 to download mp4 *
`,
                footer: tlang().footer,
                headerType: 4,
            };
